...
import static io.trino.sql.cli.TestQueryRunner.createClientSession;
import static io.trino.sql.cli.TestQueryRunner.createQueryRunner;
import static io.trino.sql.cli.TestQueryRunner.createResults;
import static io.trino.sql.cli.TestQueryRunner.nullPrintStream;
...
public class TestInsecureQueryRunner
{
            ...
            throws Exception
    {
        ...
        try (Query query = queryRunner.startQuery("query with insecure mode")) {
            query.renderOutput(TerminalUtils.getTerminal(), nullPrintStream(), nullPrintStream(), ClientOptions.OutputFormat.CSV, false, false);
        }
