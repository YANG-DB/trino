...
import io.trino.sql.cli.ClientOptions.OutputFormat;
...
import static io.trino.sql.cli.Completion.commandCompleter;
import static io.trino.sql.cli.Help.getHelpText;
import static io.trino.sql.cli.QueryPreprocessor.preprocessQuery;
import static io.trino.sql.cli.TerminalUtils.closeTerminal;
import static io.trino.sql.cli.TerminalUtils.getTerminal;
import static io.trino.sql.cli.TerminalUtils.isRealTerminal;
import static io.trino.sql.cli.TerminalUtils.terminalEncoding;
...
@Command(
        name = "trino",
        header = "Trino sql command line interface",
