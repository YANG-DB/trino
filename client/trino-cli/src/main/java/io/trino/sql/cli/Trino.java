...
import io.trino.sql.cli.ClientOptions.ClientExtraCredential;
import io.trino.sql.cli.ClientOptions.ClientResourceEstimate;
import io.trino.sql.cli.ClientOptions.ClientSessionProperty;
...
public final class Trino
{
            ...
            implements IVersionProvider
    {
        ...
        public String[] getVersion()
        {
            ...
            return new String[] {"Trino sql CLI " + firstNonNull(version, "(version unknown)")};
        }
    }
}
