...
import io.trino.gsql.cli.ClientOptions.ClientExtraCredential;
import io.trino.gsql.cli.ClientOptions.ClientResourceEstimate;
import io.trino.gsql.cli.ClientOptions.ClientSessionProperty;
...
public final class Trino
{
            ...
            implements IVersionProvider
    {
        ...
        public String[] getVersion()
        {
            ...
            return new String[] {"Trino graph sql CLI " + firstNonNull(version, "(version unknown)")};
        }
    }
}
