...
import io.trino.gsql.cli.ClientOptions.OutputFormat;
...
import static io.trino.gsql.cli.Completion.commandCompleter;
import static io.trino.gsql.cli.Help.getHelpText;
import static io.trino.gsql.cli.QueryPreprocessor.preprocessQuery;
import static io.trino.gsql.cli.TerminalUtils.closeTerminal;
import static io.trino.gsql.cli.TerminalUtils.getTerminal;
import static io.trino.gsql.cli.TerminalUtils.isRealTerminal;
import static io.trino.gsql.cli.TerminalUtils.terminalEncoding;
...
@Command(
        name = "trino-gsql",
        header = "Trino grqph sql command line interface",
        synopsisHeading = "%nUSAGE:%n%n",
        optionListHeading = "%nOPTIONS:%n",
        usageHelpAutoWidth = true,
        versionProvider = Trino.VersionProvider.class)
public class Console
        implements Callable<Integer>
{
    public static final Set<String> STATEMENT_DELIMITERS = ImmutableSet.of(";", "\\G");

    private static final String PROMPT_NAME = "trino-gsql";
