        ...
        extends Statement
{
    ...
    public ShowGraphs(Optional<QualifiedName> schema, Optional<String> likePattern, Optional<String> escape)
    {
        this(Optional.empty(), schema, likePattern, escape);
    }

    public ShowGraphs(NodeLocation location, Optional<QualifiedName> schema, Optional<String> likePattern, Optional<String> escape)
    {
        this(Optional.of(location), schema, likePattern, escape);
    }

    private ShowGraphs(Optional<NodeLocation> location, Optional<QualifiedName> schema, Optional<String> likePattern, Optional<String> escape)
    {
        super(location);
    ...
    {
        return visitor.visitShowGraphs(this, context);
    }
